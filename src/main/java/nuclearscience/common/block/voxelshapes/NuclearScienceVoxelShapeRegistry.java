...
public class NuclearScienceVoxelShapeRegistry {
    ...
    public static final VoxelShapeProvider GAS_CENTRIFUGE = VoxelShapeProvider.createDirectional(
            ...
            Stream.of(
                    //
                    Shapes.box(0.5625, 0.921875, 0.26875, 1.0234375, 1.03125, 0.73125),
                    //
                    Shapes.box(0, 0.0625, 0, 1, 0.125, 1),
                    //
                    Shapes.box(0.25, 0, 0.25, 0.75, 0.0625, 0.75),
                    //
                    Shapes.box(0, 0, 0, 0.0625, 0.0625, 1),
                    //
                    Shapes.box(0.0625, 0, 0, 0.9375, 0.0625, 0.0625),
                    //
                    Shapes.box(0.0625, 0, 0.9375, 0.9375, 0.0625, 1),
                    //
                    Shapes.box(0.9375, 0, 0, 1, 0.0625, 1),
                    //
                    Shapes.box(0.125, 0.125, 0.125, 0.875, 0.1875, 0.8715),
                    //
                    Shapes.box(0.75, 0.125, 0.28125, 1, 0.8125, 0.71875),
                    //
                    Shapes.box(0.234375, 0.125, 0.25, 0.75, 0.3125, 0.75),
                    //
                    Shapes.box(0.390625, 0.875, 0.375, 0.5890625, 0.984375, 0.625),
                    //
                    Shapes.box(0.7765625, 0.3125, 0.5625, 0.8390625, 0.34375, 0.671875),
                    //
                    Shapes.box(0.2453125, 0.3125, 0.609375, 0.3078125, 0.34375, 0.75),
                    //
                    Shapes.box(0.2453125, 0.3125, 0.25, 0.3078125, 0.34375, 0.390625),
                    //
                    Shapes.box(0.7765625, 0.3125, 0.328125, 0.8390625, 0.34375, 0.4375),
                    //
                    Shapes.box(0.7765625, 0.125, 0.5625, 0.8390625, 0.3125, 0.671875),
                    //
                    Shapes.box(0.7765625, 0.125, 0.328125, 0.8390625, 0.3125, 0.4375),
                    //
                    Shapes.box(0.2453125, 0.125, 0.609375, 0.3078125, 0.3125, 0.75),
                    //
                    Shapes.box(0.2453125, 0.125, 0.25, 0.3078125, 0.3125, 0.390625),
                    //
                    Shapes.box(0.375, 0.3125, 0.5625, 0.4375, 0.4375, 0.625),
                    //
                    Shapes.box(0.5625, 0.3125, 0.5625, 0.625, 0.4375, 0.625),
                    //
                    Shapes.box(0.4375, 0.3125, 0.4375, 0.5625, 1, 0.5625),
                    //
                    Shapes.box(0.5625, 0.3125, 0.375, 0.625, 0.4375, 0.4375),
                    //
                    Shapes.box(0.34375, 0.3125, 0.46875, 0.40625, 0.4375, 0.53125),
                    //
                    Shapes.box(0.46875, 0.3125, 0.59375, 0.53125, 0.4375, 0.65625),
                    //
                    Shapes.box(0.46875, 0.3125, 0.34375, 0.53125, 0.4375, 0.40625),
                    //
                    Shapes.box(0.375, 0.3125, 0.375, 0.4375, 0.4375, 0.4375),
                    //
                    Shapes.box(0.59375, 0.3125, 0.46875, 0.65625, 0.4375, 0.53125)
                    //    
            ).reduce(Shapes::or).get()
            //
    );
