...
public class NuclearScienceCapabilities {
    ...
    public static final EntityCapability<IRadiationRecipient, Void> CAPABILITY_RADIATIONRECIPIENT = EntityCapability.createVoid(NuclearScience.rl("radiationrecipient"), IRadiationRecipient.class);
