package nuclearscience.compatibility.jei.recipecategories.fluiditem2gas.specificmachines;

import electrodynamics.compatibility.jei.recipecategories.fluiditem2gas.FluidItem2GasRecipeCategory;
...
public class NuclearBoilerRecipeCategory extends FluidItem2GasRecipeCategory<NuclearBoilerRecipe> {
	...
	public static final GasGaugeObject OUT_GAUGE = new GasGaugeObject(108, 5, 5000);
	...
	public NuclearBoilerRecipeCategory(IGuiHelper guiHelper) {
		super(guiHelper, NuclearTextUtils.jeiTranslated(NuclearBoilerRecipe.RECIPE_GROUP), INPUT_MACHINE, BACK_WRAP, RECIPE_TYPE, ANIM_TIME);
		...
		setGasOutputs(guiHelper, OUT_GAUGE);
