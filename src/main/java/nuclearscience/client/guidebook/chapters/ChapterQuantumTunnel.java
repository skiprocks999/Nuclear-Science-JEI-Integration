...
public class ChapterQuantumTunnel extends Chapter {
    ...
    private static final ItemWrapperObject LOGO = new ItemWrapperObject(7, 10, 32, 32, 32, 2.0F, NuclearScienceItems.ITEMS_NUCLEARMACHINE.getValue(SubtypeNuclearMachine.quantumcapacitor));
    ...
    public void addData() {
        ...
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 150, 150, 150, NuclearScience.rl("textures/screen/guidebook/quantumtunnel1.png")));
        ...
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75, NuclearScience.rl("textures/screen/guidebook/quantumtunnel2.png")));
        pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.quantumtunnel.l4.2")).setSeparateStart());
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 150, 150, 150, NuclearScience.rl("textures/screen/guidebook/quantumtunnel3.png")));
        ...
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75, NuclearScience.rl("textures/screen/guidebook/quantumtunnel4.png")));
        ...
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 150, 150, 150, NuclearScience.rl("textures/screen/guidebook/quantumtunnel5.png")));
        pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.quantumtunnel.l6.2")).setSeparateStart());
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 150, 150, 150, NuclearScience.rl("textures/screen/guidebook/quantumtunnel6.png")));
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75, NuclearScience.rl("textures/screen/guidebook/quantumtunnel7.png")));
        ...
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75, NuclearScience.rl("textures/screen/guidebook/quantumtunnel8.png")));
        pageData.add(new TextWrapperObject(NuclearTextUtils.guidebook("chapter.quantumtunnel.l7.2")).setSeparateStart());
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75, NuclearScience.rl("textures/screen/guidebook/quantumtunnel9.png")));
        ...
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 75, 150, 75, NuclearScience.rl("textures/screen/guidebook/quantumtunnel10.png")));
